...
def main(): 
	...
	writePath = '/media/blade091/新加卷/Data/TAM-Data/Using/arranged_in_good_look'
	writeFile = open(writePath, 'a')
	for z in range(-1,Z):	
		if z == -1: 
			writeFile.write("Background")
			writeFile.write(' ')
		else: 
			writeFile.write( "Topic") 
			writeFile.write(str(z+1))
			writeFile.write(' ')
		...
		for y in range(Y):
			writeFile.write("Aspect")
			writeFile.write(str(y+1))
			writeFile.write(' ')
